    ...
    <div className="min-h-screen bg-gray-900 flex flex-col lg:flex-row">
      ...
      <div className="w-full lg:w-1/2 flex items-start justify-center p-20">
        <div className="w-full max-w-md text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Join the Night</h2>
          <p className="text-gray-400 mb-12">Create your account and start exploring</p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <p className="text-white text-sm">By creating an account, you agree to our Terms of Service and Privacy Policy</p>
            {/* Submit Button */}
            <button
              type="submit"
